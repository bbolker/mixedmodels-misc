...
`MCMCglmm` fit takes about `r round(MCMC_time["elapsed"]/60)` minutes ... effective sample size is 1000, which means the initial suggested 5 million steps may be overkill ?
