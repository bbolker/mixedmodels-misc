...
- Julia version 0.5.x (or greater??): on Ubuntu you can
```
...
- the `rjulia` package for R. I needed to create a modified version (in R, `devtools::install_github("bbolker/rjulia", ref="julia0.5")`
...
- the timings below are on the order of 10x greater than Doug Bates reports (e.g. the glmm fit takes about 50 seconds for him rather than 800 as reported below)
...
## Julia timings are for GLM, GLMM:logit, GLMM:cloglog
