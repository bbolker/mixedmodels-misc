...
This is an informal FAQ list for the `r-sig-mixed-models` mailing list (the mailing list is at `r-sig-mixed-models@r-project.org`, with [Gmane archives](http://news.gmane.org/gmane.comp.lang.r.lme4.devel/) available as well). There is a previous version posted on [wikidot.com](http://glmm.wikidot.com/faq), but I am getting tired of maintaining it in that format.
