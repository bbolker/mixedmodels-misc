...
This is an informal FAQ list for the `r-sig-mixed-models` mailing list (the mailing list is at `r-sig-mixed-models@r-project.org`, with [Gmane archives](http://news.gmane.org/gmane.comp.lang.r.lme4.devel/) available as well). There is a previous version posted on [wikidot.com](http://glmm.wikidot.com/faq), but I am getting tired of maintaining it in that format. The source code of this document is available at https://github.com/bbolker/mixedmodels-misc/blob/master/glmmFAQ.rmd ; a rendered (HTML) version lives at http://tinyurl.com/glmmFAQ .
...
- @matuschek_balancing_2015 and @bates_parsimonious_2015 strongly disagree, suggesting that models should be simplified *a priori* whenever possible; they also provide [tools](https://github.com/dmbates/RePsychLing) for diagnosing and mitigating singularity.
