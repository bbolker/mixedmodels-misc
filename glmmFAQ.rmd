...
- a presentation at UseR! 2009 ([abstract](http://www.agrocampus-ouest.fr/math/useR-2009/abstracts/pdf/SanchezEspigares+Ocana.pdf), [slides](http://www.agrocampus-ouest.fr/math/useR-2009/slides/SanchezEspigares+Ocana.pdf)) went into detail about a proposed `bootMer` package and suggested it could work for GLMMs too -- but it does not seem to be active.
...
Clark and Linzer (2013) have an [unpublished paper](http://www.tomclarkphd.com/workingpapers/randomeffects.pdf) addressing this question from a mostly econometric perspective, focusing mostly on practical variance/bias/RMSE criteria.
...
Here is some code that uses the relatively new `packdep` package to find and plot the dependencies of lme4 and nlme on CRAN and r-forge: 
